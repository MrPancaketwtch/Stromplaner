...
2. **Beim ersten Start:** **↥ Laden** → Standard-Datei aus `Standardeinstellungen` auswählen *(danach nicht mehr nötig – das Tool merkt sich alles automatisch)*
3. Planen
...
| `Standardeinstellungen/` | Standard-JSON mit allen Kästen und Verbrauchern – **einmalig** beim ersten Start laden (danach speichert das Tool den Zustand automatisch im Browser) |
