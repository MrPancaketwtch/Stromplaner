...
export default function App() {
  ...
  const [inspSign,     setInspSign]     = useState(()=>localStorage.getItem('sp_insp_sign')||"");
  const uploadInspSign = e => {
    const f=e.target.files?.[0]; if(!f) return;
    const r=new FileReader();
    r.onload=()=>{ setInspSign(r.result); localStorage.setItem('sp_insp_sign',r.result); };
    r.readAsDataURL(f); e.target.value="";
  };
  const removeInspSign = ()=>{ setInspSign(""); localStorage.removeItem('sp_insp_sign'); };
  ...
  const panelStyle=(k)=>({display:tab===k?"block":"none",...(tab===k?{animation:`tabSlide${tabDir>0?'R':'L'} 0.18s ease`}:{})});
...
const BMC_QR = "data:image/png;base64,";
      ...
      <div style={box}>
        ...
        <div style={{display:'flex',gap:10,justifyContent:'center'}}>
          <button style={btn({background:'#f5a623',color:'#1b2026'})}
            onClick={()=>{ window.open('https://buymeacoffee.com/Mr_Pancake','_blank'); onClose(); }}>
...
function SchematicTab({ instances,instById,boxTypeById,rootInstances,mainConns,mainConnById,isAdapted,svgRef,placements,loadById }) {
  ...
  const SymCEE3ph = ({x,y,s=1,col="#9aa4af"}) => (
    <g transform={`translate(${x},${y}) scale(${s})`}>
      ...
      <circle cx="10"    cy="4.46"  r="1.5" fill={col}/>
      <circle cx="15.27" cy="8.29"  r="1.5" fill={col}/>
      <circle cx="13.26" cy="14.49" r="1.5" fill={col}/>
      <circle cx="6.74"  cy="14.49" r="1.5" fill={col}/>
      <circle cx="4.73"  cy="8.29"  r="1.5" fill={col}/>
    </g>
  );
  ...
  const LEAF_H = 38;
  const LEAF_GAP= 6;
  const GRP_PAD= 5;   // Puffer um Steckplatz-Gruppe (oben/unten/links/rechts)
  const GRP_LBL= 14;  // Höhe des Steckplatz-Labels über der Gruppe
  const PAD    = 46;
  const ROW_GAP = 20;
  ...
  Object.values(stacksByCol).forEach(colStacks => {
    ...
    colStacks.forEach(stack => {
      const vTop = GRP_LBL + GRP_PAD; // Platz über Consumer-Bereich (Label + Border)
      const vBot = GRP_PAD;            // Platz unter Consumer-Bereich (Border)
      let top = stack.idealTop;
      let changed = true;
      while(changed) {
        changed = false;
        for(const r of [...blockedByNodes, ...placed].sort((a, b) => a.top - b.top)) {
          if((top - vTop) < r.bottom && (top + stack.totalH + vBot) > r.top) {
            top = r.bottom + vTop + 4;
            changed = true; break;
          }
        }
      }
      placed.push({ top: top - vTop, bottom: top + stack.totalH + vBot });
          ...
          {instances.map(inst=>{
            ...
            return (
              <g key={inst.id} transform={`translate(${pos.x},${pos.y})`}>
                ...
                <text x={9} y={16} fill="#cdd6df" fontSize={11} fontWeight="700">
                  {inst.name.length>24?inst.name.slice(0,23)+"…":inst.name}
                </text>
                <text x={9} y={26} fill="#4a5a6a" fontSize={7.5}>
                  {dispTypeName}
                </text>
                {adapted&&(
...
function InspectionTab({ instances, instById, boxTypeById, mainConns, mainConnById, meta, placements, loadById, inspMeta, setInspMeta, inspResults, setInspResults, inspSign, uploadInspSign, removeInspSign }) {
  const openHelp=useContext(HelpContext);
  ...
  const exportInspectionPDF = () => { try {
    ...
    const _sig=localStorage.getItem('sp_insp_sign')||"";
